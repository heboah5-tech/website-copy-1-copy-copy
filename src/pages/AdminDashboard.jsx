...
function isOnline(updatedDate) {
  return Date.now() - new Date(updatedDate) < 5 * 60 * 1000; // 5 min
}
...
export default function AdminDashboard() {
  ...
  return (
    <div className="flex h-screen bg-[#17212b] text-white font-sans overflow-hidden" dir="rtl">
      {/* Sidebar */}
      <div className="w-full md:w-80 flex-shrink-0 flex flex-col border-l border-[#232e3c] bg-[#17212b]"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex justify-between items-center mt-0.5">
                    ...
                    <span className={`text-[10px] px-1.5 py-0.5 rounded-full flex-shrink-0 mr-1 ${
                      app.current_step === "completed" ? "bg-green-500/20 text-green-400" :
      ...
      <div className={`flex-1 flex flex-col ${!selected ? "hidden md:flex" : "flex"}`}>
        {!selected ? (
          ...
          <>
            {/* Chat Header */}
            <div className="px-4 py-3 bg-[#1c2733] border-b border-[#232e3c] flex items-center gap-3">
              <button onClick={() => setSelected(null)} className="md:hidden text-gray-400 hover:text-white ml-1">
                ←
              </button>
              ...
              <div className="mr-auto">
                <span className={`text-xs px-2 py-1 rounded-full font-semibold ${
                  selected.current_step === "completed" ? "bg-green-500/20 text-green-400" :
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-[#0e1621]"
              ...
              <ChatBubble
                ...
                time={selected.updated_date}
                rows={[
                  ["الحالة", selected.status === "completed" ? "✅ مكتمل" : "⏳ جارٍ"],
